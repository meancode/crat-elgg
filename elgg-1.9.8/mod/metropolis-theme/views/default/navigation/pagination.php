...
$pages->prev = array(
	...
	'href' => '',
	'span_before' => true,
	'icon_class_before' => 'elgg-icon-sync',
	'link_icon_before' => 'elgg-icon-icon-swapleft onleft',
	'is_trusted' => true,
);
$pages->next = array(
	'text' => elgg_echo('next') ,
	'href' => '',
	'span_after' => true,
	'icon_class_after' => 'elgg-icon-sync',
...
if ($pages->prev['href']) {
	...
	echo "<li class=\"elgg-state-disabled\"><section>{$pages->prev['text']}</section></li>";
}

foreach ($pages->items as $page) {
	if ($page == $current_page) {
		echo "<li class=\"elgg-state-selected\"><section>$page</section></li>";
	} else {
...
if ($pages->next['href']) {
	...
	echo "<li class=\"elgg-state-disabled\"><section>{$pages->next['text']}</section></li>";
}
